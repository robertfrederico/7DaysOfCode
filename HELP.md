...
* The original package name 'br.com.alura.7DaysOfCode' is invalid and this project uses 'br.com.alura.DaysOfCode' instead.
...
```
$ docker run --rm -p 8080:8080 7DaysOfCode:0.0.1-SNAPSHOT
```
